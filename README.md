...
## デモ
https://sakura-studio3939.github.io/agrifake/  
※デモ環境のため、バックエンド機能など一部はご利用いただけません。
...
## 動作環境 
本アプリケーションは現在開発途中のため、
バックエンドを含む完全なデプロイは行っておりません。  
フロントエンドはGitHub Pagesにて公開しています。 
### 環境設定
...
Notion：  
https://www.notion.so/31fa41d8965780e3b2e4f83762af2951?source=copy_link
